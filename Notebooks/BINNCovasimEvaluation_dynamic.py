...
###Calculating R0###
p = 0.3332 #asymptotic probability for testing for caclulating R0
d = 0.0007 #ftality rate for calculating R0
l = 0.1 #recovery rate
mu = 0.1 #probability of sympromatic getting tested
x = data[:,0] ### S
y = data[:,3] ### A
z = data[:,4] ### Y
...
C = (d*p + l + mu*p)/(l*(d+l+mu))
R0 = [item * C for item in res1]
plt.plot(t, R0)
plt.show()
