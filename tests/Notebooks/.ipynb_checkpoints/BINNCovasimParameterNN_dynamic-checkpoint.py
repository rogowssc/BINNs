...
# mydir = '../models/covasim/2022-12-19_15-22-50' # constant
# mydir = '../models/covasim/2022-12-22_15-47-23' # constant
# mydir = '../models/covasim/2022-12-08_19-43-15' # piecewise
mydir = '../models/covasim/2024-11-12_12-31-26'
...
for i in range(3):
    ...
    if i == 0:
        ...
        ax.plot_surface(Z, Y, res, cmap=cm.coolwarm, alpha=1)
        ax.scatter(Z.reshape(-1), Y.reshape(-1), res.reshape(-1), s=5, c='k')
